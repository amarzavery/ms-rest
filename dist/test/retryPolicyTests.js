...
var exponentialRetryPolicyFilter_1 = require("../lib/filters/exponentialRetryPolicyFilter");
...
describe.skip('exponentialretrypolicyfilter-unittests', function () {
    it('RetrySucceedsOnHttp408StatusCode', function (done) {
        ...
        var response = new nodeFetch.Response();
        response.status = 408;
        ...
        var mockRetryPolicyFilter = new exponentialRetryPolicyFilter_1["default"](retryCount, retryInterval, minRetryInterval, maxRetryInterval);
        var req = new webResource_1.WebResource();
        var opRes = new httpOperationResponse_1["default"](req, response);
        mockRetryPolicyFilter.after(opRes).then(function (opRes) {
            console.log(opRes);
        });
    });
