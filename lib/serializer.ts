...
export class Serializer {
  ...
  serializeDictionaryType(mapper: DictionaryMapper, object: any, objectName: string) {
    ...
    let tempDictionary: { [key: string]: any } = {};
  ...
  serialize(mapper: Mapper, object: any, objectName: string): any {
    let payload: any = {};
    let mapperType = mapper.type.name as string;
    ...
    if (mapperType.match(/^(Number|String|Boolean|Object|Stream|Uuid)$/ig) !== null) {
      ...
      let enumMapper: EnumMapper = mapper as EnumMapper;
  ...
  private getPolymorphicMapperObjectVersion(mapper: CompositeMapper, object: any, objectName: string, mode: string): CompositeMapper {
    ...
    let discriminatorAsObject: PolymorphicDiscriminator = mapper.type.polymorphicDiscriminator as PolymorphicDiscriminator;
  ...
  private getPolymorphicMapperStringVersion(mapper: CompositeMapper, object: any, objectName: string): CompositeMapper {
    //check for polymorphic discriminator
    let discriminatorAsString: string = mapper.type.polymorphicDiscriminator as string;
