...
export class WebResource {
  ...
  constructor(url?: string, method?: string, body?: any, query?: { [key: string]: any; }, headers: { [key: string]: any; } = {}, rawResponse: boolean = false) {
  ...
  prepare(options: RequestPrepareOptions) {
    ...
    if (options.queryParameters) {
      ...
      for (let queryParamName in queryParameters) {
        let queryParam: any = queryParameters[queryParamName];
        if (queryParam) {
